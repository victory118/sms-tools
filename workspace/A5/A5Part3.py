...
def mainlobeTracker(inputFile = '../../sounds/sines-440-602-hRange.wav'):
    ...
    t = -65                                               # threshold (negative dB)

    # The side lobe peak of a blackman-harris window is -78 dB
    # The difference between the magnitudes of the two sinusoids is 20*log10(2e-3) = -53.98 dB
    # Thus, the magnitude threshold to capture both peaks should be between -53.98 and -78 dB
